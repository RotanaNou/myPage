...
function createSlider() {
    ...
    //binding between key and slider using .on function
    $("#start_hor").on("keyup", function() {
        $("#sh_slider").slider("value", this.value);
        submitAuto();
    });
    ...
    //binding between key and slider using .on function
    $("#end_hor").on("keyup", function() {
        $("#eh_slider").slider("value", this.value);
        submitAuto();
    });
    ...
    //binding between key and slider using .on function
    $("#start_ver").on("keyup", function() {
        $("#sv_slider").slider("value", this.value);
        submitAuto();
    });
    ...
    //binding between key and slider using .on function 
    $("#end_ver").on("keyup", function() {
        $("#ev_slider").slider("value", this.value);
        submitAuto();
    });
}
//a global vairable
